...
//
//@Component
//public class RecipeBootstrapCommandLineRunner implements CommandLineRunner {
////@Component
////public class RecipeBootstrapApplicationListener implements ApplicationListener<ContextRefreshedEvent> {
//
//    CategoryRepository categoryRepository;
//    RecipeRepository recipeRepository;
//    UnitOfMeasureRepository unitOfMeasureRepository;
//
//    public RecipeBootstrapCommandLineRunner(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository) {
//        System.out.println("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% RecipeBootstrapApplicationListener constructor");
...
//        System.out.println("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% RecipeBootstrapApplicationListener run");
//        getRecipes();
//    }
//
////    @Override
////    public void onApplicationEvent(ContextRefreshedEvent event) {
////        System.out.println("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% RecipeBootstrapApplicationListener onAplicatinEvent");
////        recipeRepository.saveAll(getRecipes());
////    }
//
//    private List<Recipe> getRecipes() {
//        System.out.println("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% RecipeBootstrapApplicationListener getRecipes");
//
//
