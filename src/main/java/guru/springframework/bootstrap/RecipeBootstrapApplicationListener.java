...
public class RecipeBootstrapApplicationListener implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeBootstrapApplicationListener(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository) {
